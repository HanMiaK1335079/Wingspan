...
public class Ability {
    ...
    public boolean mentionsLayEgg() {
        return rawText.toLowerCase(Locale.ROOT).contains("lay 1 [egg]")
                || rawText.toLowerCase(Locale.ROOT).contains("lay 1 egg");
    }
    ...
    public boolean isDiscardEggAbility() {
        return rawText.toLowerCase(Locale.ROOT).contains("discard")
                && rawText.toLowerCase(Locale.ROOT).contains("[egg]");
    }
