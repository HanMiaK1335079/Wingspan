...
public class Tester {
    ...
    private static String[] bonuses = { "Anatomist", "Cartographer", "Historian", "Photographer", "Backyard Birder",
    ...
    public static void readCSV(File f) {
        ...
        try {
            ...
            while (scan.hasNextLine()) {
                ...
                b = Bird.create(items[0], abilityActivate, items[2], abilityType, Integer.parseInt(items[6]), items[7],
                        Integer.parseInt(items[8]), Integer.parseInt(items[9]), habitats, foodLists);
                birds.add(b);
